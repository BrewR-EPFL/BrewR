...
class JourneyRecordScreenTest {
    ...
    fun displayAllComponents() {
        ...
        composeTestRule.onNodeWithTag("coffeeShopName").assertTextEquals("Coffee Shop: Mock Coffee Shop")
        composeTestRule.onNodeWithTag("description").assertTextEquals("Description: Matcha Latte looks like android")
        composeTestRule.onNodeWithTag("origin").assertTextEquals("Origin: BRAZIL")
        composeTestRule.onNodeWithTag("brewingMethod").assertTextEquals("Brewing Method: ESPRESSO_MACHINE")
